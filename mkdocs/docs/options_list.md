...
* [mod_full_paren_if_bool](other_options/mod_full_paren_if_bool.md): Whether to fully parenthesize Boolean expressions in 'while' and 'if' statement.
...
* [mod_full_paren_if_bool](other_options/mod_full_paren_if_bool.md)
